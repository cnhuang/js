...
tvData = [
  ...
  SHOW('http://www.tw116.com/occident/shendunjutegongdiwuji/', 0, 'shield 5'),
...
movieData = [
  ...
  SHOW('http://www.tw116.com/action/leishen3zhushenhuanghun/'),
  SHOW('http://www.tw116.com/horror/muqin/'),
  SHOW('http://www.tw116.com/drama/shengluzhisi/'),
  SHOW('http://www.tw116.com/action/jidaocheshen/'),
  SHOW('http://www.tw116.com/drama/taochujuemingzhen/'),
  SHOW('http://www.tw116.com/horror/lingyikongjianbiechuangyinyangjietaimaibotanceqi/', '', '別闖陰陽界 Flatliners'),
  SHOW('http://www.tw116.com/horror/xiaochouhuihun/', '', '牠 It'),
  SHOW('http://www.tw116.com/fiction/quanqiufengbao/', '', 'Geostorm'),
  SHOW('http://www.tw116.com/fiction/yinyishashou2049/', '', 'blade runner 2049'),
  SHOW('古墓奇兵 Tomb Raider'),
  SHOW('http://www.tw116.com/drama/dongfangkuaichemoushaan/', '', '東方快車謀殺案'),
  SHOW('http://www.tw116.com/horror/jirikuaile/', '', '忌日快樂'),
  SHOW('http://www.tw116.com/drama/xueren/', '', '雪人'),
  ...
  SHOW('http://www.tw116.com/fiction/xingqiudazhan8zuihoudejuediwushi/'),
  SHOW('http://www.tw116.com/fiction/tianjihaojie2/'),
  SHOW('http://www.tw116.com/fiction/wuxianmishi/'),
  SHOW('http://www.tw116.com/fiction/tianjixiantianjihaojie/'),
  SHOW('http://www.tw116.com/fiction/nuenueshaqiguan/'),
  SHOW('http://www.tw116.com/comedy/sankuaiguanggaopai/'),
  SHOW('http://www.tw116.com/horror/louxiadefangke/'),
  SHOW('ferdinand'),
